...
{
System.out.println("");
System.out.println("You have hashed " + TotalBlocks + " Block(s)!");
System.out.println("");
System.out.println("Your total balance from mining on ledger_formatted is " + FinalBalance + " KMC");
System.out.println("");
writer34.close();
reader34.close();
}
...
//89ac087455237a2a84b3fa1f3c0978fb621506fe202d997d55bdd42fb0916604